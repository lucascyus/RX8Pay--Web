    ...
    public class Relatorio
    {
        public static void GerarRelatorio()
        {
            ...
            using (SqlConnection connection = new SqlConnection(connectionString))
            {
                ...
                // Criar a série de dados (gráfico de barras)
                Series series = new Series();
                series.ChartType = SeriesChartType.Column; // Tipo de gráfico de barras
                series.Name = "Gastos";

                // Adicionar dados à série (altere esses valores conforme necessário)
                series.Points.Add(new DataPoint(0, (double)totalSalariosPagos) { Color = System.Drawing.Color.Blue });
                series.Points.Add(new DataPoint(1, (double)totalSalariosNovos) { Color = System.Drawing.Color.Green });
                series.Points.Add(new DataPoint(2, (double)(totalSalariosPagos + totalSalariosNovos)) { Color = System.Drawing.Color.Red });
                ...
                var chartImage = iTextSharp.text.Image.GetInstance(imagePath);
